...
##########################################################################
num_of_tweets=1 #enter number of tweets x 100 that need to be extracted
...
i=0
iterator=twitter.search.tweets(q = "#DrStrange", result_type='recent', lang='en', count = 100)
n_max = float('+inf')
n_min = float('-inf')
...
for i in range(num_of_tweets):
	...
	i += 1
	print count
	iterator=twitter.search.tweets(q = "#DrStrange", result_type='recent', lang='en', count = 100, max_id=min_id)
